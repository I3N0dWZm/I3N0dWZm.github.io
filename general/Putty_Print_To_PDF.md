...
Follow the instructions to build libharu and copy to the root of the putty source folder. (libharu-2.4.4/src/*.c to root dir of putty source, libharu-2.4.4/src/debug/* to root dir of putty source)
